...
public class FileTableBuilder extends AbstractComponentBuilder {
	...
	public Object buildComponentData(ComponentConfig arg0, ComponentParams arg1) throws Exception {
		...
		String projectName = IntegrationUtil.trim(params.getParameter("projectName"));
		String projectID = IntegrationUtil.trim(params.getParameter("projectID"));
		String projectType = IntegrationUtil.trim(params.getParameter("projectType"));
		String projectDescribe = IntegrationUtil.trim(params.getParameter("projectDescribe"));
		String taskName = IntegrationUtil.trim(params.getParameter("taskName"));
		String taskID = IntegrationUtil.trim(params.getParameter("taskID"));
		String taskDescribe = IntegrationUtil.trim(params.getParameter("taskDescribe"));
		String softwareName = IntegrationUtil.trim(params.getParameter("softwareName"));
		String softwareID = IntegrationUtil.trim(params.getParameter("softwareID"));
		String paraName = IntegrationUtil.trim(params.getParameter("paraName"));
		String paraID = IntegrationUtil.trim(params.getParameter("paraID"));
		String fileName = IntegrationUtil.trim(params.getParameter("fileName"));
		String fileID = IntegrationUtil.trim(params.getParameter("fileID"));
		String fileType = IntegrationUtil.trim(params.getParameter("fileType"));
		String fileDescribe = IntegrationUtil.trim(params.getParameter("fileDescribe"));
		String fileAuthor = IntegrationUtil.trim(params.getParameter("fileAuthor"));
		String fileOrgan = IntegrationUtil.trim(params.getParameter("fileOrgan"));
